...
const (
	...
	InvalidEmailErrMsg             = "email is not valid"
	ResponseMsgErrorInternalServer = "internal server error"
	ValidationErrorMsg             = "validation error"
	NotFoundErrorMsg               = "not found"
	InvalidAuthTokenErrMsg         = "token is not valid"
	InvalidCredentialsErrMsg       = "username or password is wrong"
